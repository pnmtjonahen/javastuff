...
public class SecurityRoleDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public SecurityRoleDescriptor() 
     {
        ...
        desc.setValidator(fieldValidator);
        //-- _roleName
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(nl.tjonahen.cpv.applicationxml.RoleName.class, "_roleName", "role-name", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    SecurityRole target = (SecurityRole) object;
                    target.setRoleName( (nl.tjonahen.cpv.applicationxml.RoleName) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            ...
            public java.lang.Object newInstance( java.lang.Object parent ) {
                return new nl.tjonahen.cpv.applicationxml.RoleName();
            }
        };
        desc.setHandler(handler);
        ...
        desc.setValidator(fieldValidator);
    } //-- nl.tjon.a.hen.applicationxml.SecurityRoleDescriptor()
    ...
    {
        return nl.tjonahen.cpv.applicationxml.SecurityRole.class;
